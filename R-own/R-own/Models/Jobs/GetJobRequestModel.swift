...
struct GetJobRequestModel: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id = "_id"
        case userID, designationType, noticePeriod, department, preferredLocation, expectedCTC, employmentType, status
