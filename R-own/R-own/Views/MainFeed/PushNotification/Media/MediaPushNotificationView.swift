//
//  ImagePushNotificationView.swift
//  R-own
//
...
struct MediaPushNotificationView: View {
                        ...
                        HStack{
                            Button(action: {
                                if isPushNotification{
                                    loginData.notificationPostView.toggle()
                                } else {
...
//struct ImagePushNotificationView_Previews: PreviewProvider {
//    static var previews: some View {
//        ImagePushNotificationView()
//    }
//}
