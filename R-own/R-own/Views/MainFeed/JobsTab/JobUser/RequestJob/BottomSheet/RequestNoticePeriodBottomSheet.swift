//
//  RequestNoticePeriodBottomSheet.swift
//  R-own
//
...
struct RequestNoticePeriodBottomSheet: View {
                                ...
                                VStack(alignment: .leading){
                                    VStack{
                                        Text("No")
                                            ...
                                            .onTapGesture{
                                                jobsVM.noticePeriodRequestedFor = "No"
                                    ...
                                    VStack{
                                        Text("< 1 Month")
                                            .padding(.vertical, UIScreen.screenHeight/60)
                                            .onTapGesture{
                                                jobsVM.noticePeriodRequestedFor = "< 1 Month"
                                                jobsVM.requestedNoticePeriodBottomSheet = false
                                            }
                                        Divider()
                                    }
                                    ...
                                    VStack{
                                        Text("2 Month")
                                            .padding(.vertical, UIScreen.screenHeight/60)
                                            .onTapGesture{
                                                jobsVM.noticePeriodRequestedFor = "2 Month"
                                                jobsVM.requestedNoticePeriodBottomSheet = false
                                            }
                                        Divider()
                                    }
                                    VStack{
                                        Text("3 Month")
                                            .padding(.vertical, UIScreen.screenHeight/60)
                                            .onTapGesture{
                                                jobsVM.noticePeriodRequestedFor = "3 Month"
                                                jobsVM.requestedNoticePeriodBottomSheet = false
                                            }
                                        Divider()
                                    }
...
//struct RequestNoticePeriodBottomSheet_Previews: PreviewProvider {
//    static var previews: some View {
//        RequestNoticePeriodBottomSheet()
//    }
//}
