//
//  ProfessionalProfileJobsBottomSheet.swift
//  R-own
//
...
struct ProfessionalProfileAddJobsBottomSheet: View {
        ...
        ZStack{
            VStack{
                ...
                Button(action: {
                    ...
                    Task{
                        let res = await profileService.updateExperienceforNormalUser(userID: loginData.mainUserID, index: String(loginData.userData.normalUserInfo.count), userDescription: "", jobType: employmentType, jobTitle: designation, hotelCompany: companyName, jobStartYear: jobStart, jobEndYear: jobEnd)
                        if res == "Success"{
                            loginData.userData.normalUserInfo.append(NormalUserInfoProfile(jobType: employmentType, jobTitle: designation, jobCompany: companyName, jobStartYear: jobStart, jobEndYear: jobEnd))
...
//struct ProfessionalProfileAddJobsBottomSheet_Previews: PreviewProvider {
//    static var previews: some View {
//        ProfessionalProfileJobsBottomSheet()
//    }
//}
