...
struct ProfessionalProfileEditJobsBottomSheet: View {
    ...
    var body: some View {
        ZStack{
            VStack{
                ...
                VStack{
                    //TextField
                    if let unwrappedText = loginData.userData.normalUserInfo[id] {
                        TextField("Your company name", text: Binding(get: {unwrappedText.jobCompany}, set: {_,_ in loginData.userData.normalUserInfo[id] = NormalUserInfoProfile(jobType: "", jobTitle: "", jobCompany: "", jobStartYear: "", jobEndYear: "")}))
                            .padding()
                            .cornerRadius(7)
                            .overlay{
                    ...
                    if let unwrappedText = loginData.userData.normalUserInfo[id] {
                        TextField("Your designation", text: Binding(get: {unwrappedText.jobTitle}, set: {_,_ in loginData.userData.normalUserInfo[id] = NormalUserInfoProfile(jobType: "", jobTitle: "", jobCompany: "", jobStartYear: "", jobEndYear: "")}))
                            .padding()
                            .cornerRadius(7)
                            .overlay{
                                // apply a rounded border
                    ...
                    if let unwrappedText = loginData.userData.normalUserInfo[id] {
                        TextField("Your employment type", text: Binding(get: {unwrappedText.jobType}, set: {_,_ in loginData.userData.normalUserInfo[id] = NormalUserInfoProfile(jobType: "", jobTitle: "", jobCompany: "", jobStartYear: "", jobEndYear: "")}))
                            .padding()
                            .cornerRadius(7)
                            .overlay{
                                // apply a rounded border
                    ...
                    HStack{
                        ...
                        if let unwrappedText = loginData.userData.normalUserInfo[id] {
                            TextField("xxxx", text: Binding(get: {unwrappedText.jobStartYear}, set: {_,_ in loginData.userData.normalUserInfo[id] = NormalUserInfoProfile(jobType: "", jobTitle: "", jobCompany: "", jobStartYear: "", jobEndYear: "")}))
                                .padding()
                        ...
                        if let unwrappedText = loginData.userData.normalUserInfo[id] {
                            TextField("xxxx", text: Binding(get: {unwrappedText.jobEndYear}, set: {_,_ in loginData.userData.normalUserInfo[id] = NormalUserInfoProfile(jobType: "", jobTitle: "", jobCompany: "", jobStartYear: "", jobEndYear: "")}))
                                .padding()
                                .keyboardType(.numberPad)
                                .cornerRadius(7)
