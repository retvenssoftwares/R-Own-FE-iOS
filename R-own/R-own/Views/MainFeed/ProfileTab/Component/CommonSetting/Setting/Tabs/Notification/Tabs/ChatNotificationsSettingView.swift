...
struct ChatNotificationsSettingView: View {
    ...
    var body: some View {
        VStack{
            BasicNavbarView(navbarTitle: "Chat Notifications")
...
//struct ChatNotificationsView_Previews: PreviewProvider {
