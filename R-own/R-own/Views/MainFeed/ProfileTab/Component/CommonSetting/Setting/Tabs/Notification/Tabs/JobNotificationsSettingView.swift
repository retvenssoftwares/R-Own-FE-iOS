...
struct JobNotificationsSettingView: View {
    ...
    var body: some View {
        VStack{
            BasicNavbarView(navbarTitle: "Job Notifications")
...
//struct JobNotificationsView_Previews: PreviewProvider {
