//
//  AdminAdvertisementPostView.swift
//  R-own
//
...
struct AdminAdvertisementPostView: View {
                                    ...
                                    .onAppear {
                                        if currentUrl == nil {
                                            DispatchQueue.main.async {
                                                currentUrl = URL(string: post.media[0].post.replacingOccurrences(of: " ", with: "%20"))
                                            }
                                        }
                                    }
                                }
...
//struct AdminAdvertisementPostView_Previews: PreviewProvider {
//    static var previews: some View {
//        AdminAdvertisementPostView()
//    }
//}
